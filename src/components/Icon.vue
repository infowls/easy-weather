<template>
  ...
  <!--cloud-->
  <svg
    v-if="this.icon == '03d' || this.icon == '03n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--clouds-->
  <svg
    v-if="this.icon == '04d' || this.icon == '04n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--rain-->
  <svg
    v-if="this.icon == '10d' || this.icon == '10n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--heavy rain-->
  <svg
    v-if="this.icon == '09d' || this.icon == '09n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--thunderstorm-->
  <svg
    v-if="this.icon == '11d' || this.icon == '11n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--snow-->
  <svg
    v-if="this.icon == '13d' || this.icon == '13n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
  ...
  <!--mist-->
  <svg
    v-if="this.icon == '50d' || this.icon == '50n'"
    xmlns="http://www.w3.org/2000/svg"
    :width="this.width"
    :height="this.height"
    :fill="this.color"
